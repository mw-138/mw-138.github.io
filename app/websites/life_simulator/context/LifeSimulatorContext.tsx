...
export const LifeSimulatorContext = createContext<LifeSimulatorContextValue>({
  ...
  isNewGame: true,
  setIsNewGame: (value: boolean) => {},
  name: "",
  setName: (name: string) => {},
  cash: 0,
  setCash: (amount: number) => {},
  bank: 0,
  setBank: (newValue: number | ((prevValue: number) => number)) => {},
  health: 0,
  setHealth: (amount: number) => {},
  hunger: 0,
  setHunger: (amount: number) => {},
  thirst: 0,
  setThirst: (amount: number) => {},
  energy: 0,
  setEnergy: (amount: number) => {},
  cashToBank: (amount: number) => {},
  bankToCash: (amount: number, force: boolean) => {},
  inDebt: false,
  storyEntries: [],
  addStoryEntry: (timestamp: number, text: string) => {},
  resetData: () => {},
  currentTimestamp: 0,
  startTimestamp: 0,
  getAge: () => 0,
